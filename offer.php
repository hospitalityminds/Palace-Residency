...
<script>
  ...
  gtag('config', 'UA-148760362-1');
        ...
        <title>Special Offers an Discounts - Hotel Palace Residency</title>
        <meta charset="utf-8">
...
<!--navbar-->
        ...
        <div class="slide-one-item home-slider owl-carousel">
            <div class="site-blocks-cover overlay" style="background-image: url(images/parklane/slider/t3.JPG);" data-aos="fade" data-stellar-background-ratio="0.5">
                <div class="container">
